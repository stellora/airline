...
import { CloneType, Kind, Type as T, TypeRegistry } from '@sinclair/typebox'
...
const schema = {
	...
	'/aircraft/{aircraftSpec}': {
		...
		PATCH: {
			args: T.Object({
				...
				body: T.Object(
					{
						registration: T.Optional(CloneType(ComponentsSchemasAircraftRegistration)),
						aircraftType: T.Optional(CloneType(ComponentsSchemasAircraftTypeIcaoCode)),
	...
	'/flight-schedules/{id}': {
		...
		PATCH: {
			args: T.Object({
				...
				body: T.Object(
					{
						airline: T.Optional(CloneType(ComponentsSchemasAirlineSpec, { 'x-in': 'path' })),
						number: T.Optional(CloneType(ComponentsSchemasFlightNumber)),
						originAirport: T.Optional(CloneType(ComponentsSchemasAirportSpec, { 'x-in': 'path' })),
				...
				body: T.Object(
					{
						...
						aircraftType: CloneType(ComponentsSchemasAircraftTypeIcaoCode),
						aircraft: T.Optional(CloneType(ComponentsSchemasAircraftSpec, { 'x-in': 'path' })),
						departureDateTime: CloneType(ComponentsSchemasZonedDateTime),
						arrivalDateTime: CloneType(ComponentsSchemasZonedDateTime),
						notes: T.String(),
						published: T.Optional(T.Boolean({ default: false })),
	...
	'/flight-instances/{id}': {
		...
		PATCH: {
				...
				body: T.Object(
					{
						...
						aircraftType: T.Optional(CloneType(ComponentsSchemasAircraftTypeIcaoCode)),
						aircraft: T.Optional(CloneType(ComponentsSchemasAircraftSpec, { 'x-in': 'path' })),
						departureDateTime: T.Optional(CloneType(ComponentsSchemasZonedDateTime)),
						arrivalDateTime: T.Optional(CloneType(ComponentsSchemasZonedDateTime)),
			...
			error: T.Union([T.Any({ 'x-status-code': '400' }), T.Any({ 'x-status-code': '404' })]),
		},
		DELETE: {
			args: T.Object({
				params: T.Object({
...
export { _components as components, schema }
