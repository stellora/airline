...
CREATE UNIQUE INDEX IF NOT EXISTS unique_flight_instance_for_date_in_schedule
ON flight_instances(source_schedule_id, source_schedule_instance_localdate)
